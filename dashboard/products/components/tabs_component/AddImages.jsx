...
import { makeStyles, CardContent, Card, TextField, Grid, Typography, FormControl, InputLabel, Input, Select, MenuItem } from '@material-ui/core'
                                    ...
                                    return (
                                        <div key={index} className={`image-item ${classes.ContainerAddedItem}`}>
                                            ...
                                            <Grid container spacing={3} wrap="wrap" alignItems="center">
                                                ...
                                                <Grid item md={3} sm={4} xs={12}>
                                                    {/* <TextField fullWidth label="Доступно?" margin="normal" name="isEnable"
                                                    onChange={(e) => { setImgDesc(e,index) }} type="isEnable" 
                                                    value={desc[index] !== undefined ? desc[index].isEnable : "false"} 
                                                    variant="outlined" /> */}
                                                    <FormControl variant="outlined" fullWidth>
                                                    <InputLabel id="demo-simple-select-helper-label">Доступно?</InputLabel>
                                                        <Select
                                                            labelId="demo-simple-select-outlined-label"
                                                            id="demo-simple-select-outlined"
                                                            name="isEnable"
                                                            value={desc[index] !== undefined ? desc[index].isEnable : "false"} 
                                                            onChange={(e) => { setImgDesc(e,index) }}
                                                            label="category"
                                                        >
                                                            <MenuItem value={'true'}>Доступно (есть в наличии)</MenuItem>
                                                            <MenuItem value={'false'}>Недоступно (нет в наличии)</MenuItem>
                                                        </Select>
                                                    </FormControl>
                                                </Grid>
                                            </Grid>
